    ...
    return (
        <form className='basic-form'>
            ...
            <div>
                ...
                <input id='email' type="email" name="email" defaultValue={props.defaultValues[3]} onChange={props.changeHandler}/>
            </div>
            <div>
                <label htmlFor='phone'>Phone</label>
                <input id='phone' type="text" name="phone" defaultValue={props.defaultValues[4]} onChange={props.changeHandler}/>
            </div>
            {props.isCreatePage &&
            <div>
